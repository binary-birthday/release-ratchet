//! Integration tests: verify that internal components produce outputs
//! consumable by other internal components. Tests the interop between
//! prepare and release, ecosystem write/read round-trips, and format
//! preservation across the tool's internal boundaries.

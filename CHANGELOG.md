...
- **ci**: skip release when HEAD is already a release commit (prevents loop) [cb16549](https://github.com/binary-birthday/release-ratchet/commit/cb16549879221db16abb3a4afb83cffefbeac0bf)
